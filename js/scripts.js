   // Dados a serem enviados no corpo da solicitaÃƒÂ§ÃƒÂ£o
   const requestData = {
    access_token: "XXXXX",
    clickid: "XXXXX",
...
// URL de destino da solicitaÃƒÂ§ÃƒÂ£o
const url = "http://www.adsnebula.com/log/common/api";

// ConfiguraÃƒÂ§ÃƒÂ£o da solicitaÃƒÂ§ÃƒÂ£o
...
// Realiza a solicitaÃƒÂ§ÃƒÂ£o usando a API Fetch
fetch(url, requestOptions)
    .then(response => response.json())
    .then(data => console.log(data))
    .catch(error => console.error("Erro na solicitaÃƒÂ§ÃƒÂ£o:", error));
...
function atualizarValor() {
    ...
    setCookie('valor', valor.toFixed(2), 365); // Armazena o valor como um cookie vÃƒÂ¡lido por 1 ano
}
...
// FunÃƒÂ§ÃƒÂ£o para aumentar o valor
function aumentarValor() {
    // Se ainda houver valores no array
    if (valoresDesejados.length > 0) {
        // Retira o prÃƒÂ³ximo valor do array
...
// POPUP Limite diÃƒÂ¡rio quando bate X valor
...
function fecharPopupEAgendarReaparecimento() {
    ...
    popupButtonContainer.style.display = "none"; // Oculta o botÃƒÂ£o

    // Define um temporizador para mostrar o botÃƒÂ£o apÃƒÂ³s 10 segundos
    setTimeout(function() {
        popupButtonContainer.style.display = "block";
    }, 86400000); // 24 horas

    // Aqui vocÃƒÂª tambÃƒÂ©m deve adicionar a funÃƒÂ§ÃƒÂ£o para fechar o popup
    closePopupL();
}

// Chama a funÃƒÂ§ÃƒÂ£o para mostrar o botÃƒÂ£o apÃƒÂ³s 10 segundos (10000 milissegundos)
setTimeout(function() {
...
// Script botÃƒÂ£o login
function showLoading() {
  var button = document.getElementById("prosseguir-button");
  button.disabled = true; // Desabilitar o botÃƒÂ£o enquanto a animaÃƒÂ§ÃƒÂ£o ocorre

  button.innerHTML = '<span class="loading-spinner"></span> Carregando...';

  // Simulando um atraso de 3 segundos para a animaÃƒÂ§ÃƒÂ£o
  setTimeout(function() {
    // Redirecionar apÃƒÂ³s o atraso
...
function formatarValor(input) {
  // Remove todos os caracteres nÃƒÂ£o numÃƒÂ©ricos
...
function verificarCampos() {
  ...
  // Atualiza o conteúdo do parágrafo com o id 'saudacao'
...
function in1() {
    ...
    showPopupInicio2();
        ...
        // Agendar a exibiÃƒÂ§ÃƒÂ£o do prÃƒÂ³ximo apÃƒÂ³s 5 segundos
        setTimeout(function() {
            closePopupInicio2();
            showPopupInicio3();
        }, 10000);
    ...
    containers.forEach(function (container) {
      ...
      buttons.forEach(function (button) {
        button.addEventListener('click', function () {
          // Remove a classe 'active' apenas do conjunto de botÃƒÂµes dentro do mesmo container
          buttons.forEach(function (btn) {
            btn.classList.remove('active');
          });
  
          // Adiciona a classe 'active' apenas ao botÃƒÂ£o clicado
